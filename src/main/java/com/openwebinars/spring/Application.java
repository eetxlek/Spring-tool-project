...
public class Application {
	...
	CommandLineRunner initData(EmpleadoRepository repositorio) {
        return (args) -> {
        	/*
            Empleado empleado1 = new Empleado("Antonio García", "antonio.garcia@openwebinars.net", "954000000");
            Empleado empleado2 = new Empleado("María López", "maria.lopez@openwebinars.net", "954000000");
            Empleado empleado3 = new Empleado("Ángel Antúnez", "angel.antunez@openwebinars.net", "954000000");
